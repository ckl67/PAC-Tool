...
public class WinEnthalpy {
	 ...
	 *  Mouse adapter
	 */
	MouseMotionAdapter mMotionAdapt = new MouseMotionAdapter() {
	...
	//	Except special @Override Mouse events, ..
	// -------------------------------------------------------
	...
	private void initialize() {
		...
		panelEnthalpyDrawArea = new PanelEnthalpy(enthalpy,eDrawL,mMotionAdapt);	
