...
import computation.MeasureChoice;
import computation.MeasurePoint;
import computation.MeasureComputation;
...
public class WinMeasurePoints {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					WinMeasurePoints window = new WinMeasurePoints(eDrawL1,measurePL1,enthalpy1,null);
	 ...
	 * @param measurePL 
	 */
	public WinMeasurePoints(List<ElDraw> veDrawL, List<Measure> vmeasurePL, Enthalpy enthalpy, WinEnthalpy vwinEnth ) {
	...
	private void initialize() {
		...
		textField.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				MeasureComputation.updateAllMeasureListElem(measurePL,enthalpy);
