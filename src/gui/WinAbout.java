...
public class WinAbout {
	...
	private void initialize() {
		...
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(WinAbout.class.getResource("/gui/images/PAC-Tool_32.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(WinAbout.class.getResource("/computation/images/PAC-Tool_64.png")));
