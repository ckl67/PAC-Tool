...
OutputBaseFilename=pactoolx86_setup
...
[Files]
Source: "D:\Users\kluges1\workspace\pac-tool\inno\PAC-Toolx86.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Users\kluges1\workspace\pac-tool\inno\jrex86\*"; DestDir: "{app}\jrex86"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Icons]
Name: "{group}\PAC-Tool"; Filename: "{app}\PAC-Toolx86.exe"
Name: "{group}\{cm:UninstallProgram,PAC-Tool}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\PAC-Tool"; Filename: "{app}\PAC-Toolx86.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\PAC-Toolx86.exe"; Description: "{cm:LaunchProgram,PAC-Tool}"; Flags: nowait postinstall skipifsilent
